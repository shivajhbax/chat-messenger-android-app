...
public void onStart()
{
	...
	FirebaseRecyclerOptions options =
			new FirebaseRecyclerOptions.Builder<ContactsContract.Contacts>()
					.setQuery(ContacsRef, ContactsContract.Contacts.class)
					.build();
	
	
	final FirebaseRecyclerAdapter<ContactsContract.Contacts, ContactsViewHolder> adapter
			= new FirebaseRecyclerAdapter<ContactsContract.Contacts, ContactsViewHolder>(options) {
		@Override
				...
				public void onDataChange(DataSnapshot dataSnapshot)
				{
					if (dataSnapshot.exists())
					{
						...
						if (dataSnapshot.hasChild("image"))
						{
							...
							Picasso.get().load(userImage).placeholder(R.drawable.photo).into(holder.profileImage);
						}
						else
						{
							String profileName = dataSnapshot.child("name").getValue().toString();
